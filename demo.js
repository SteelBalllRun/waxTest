...
// require('SYBUtils,UIApplication');
// defineClass('GBLUIJumpHandler', {
//     jumpToHotChannelList: function() {
//         SYBUtils.showTips_inView("当前版本已不支持热门频道列表页跳转", UIApplication.sharedApplication().keyWindow());
//     },
// });
